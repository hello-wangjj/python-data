...
str = urllib.urlopen('https://hk.finance.yahoo.com/q/cp?s=%5EDJI').read().decode('utf-8','ignore')
# dStr = dBytes.decode()    # in Python 3
m = re.findall(
    "<tr><td class=\"yfnc_tabledata1\"><b><a href=\".*?\">(.*?)</a></b></td><td class=\"yfnc_tabledata1\">(.*?)</td>.*?<b>(.*?)</b>.*?</tr>",
    str)
if m:
    # print m
    # print"\n"
